        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg text-text-light leading-relaxed">
              Automated Azure deployment with intelligent scaling, load balancing, and comprehensive management.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-background-alt border border-border rounded-lg p-12 text-center">
            ...
            <p className="text-text-light leading-relaxed max-w-2xl mx-auto">
              We're preparing our cloud deployment services. Stay tuned for updates.
            </p>
            <Link
              href="/services"
      ...
      <section className="py-12 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-2 text-text-white/70">
            Let's discuss your cloud deployment needs.
          </p>
          <div className="mt-4">
            <Link
              href="/contact"
